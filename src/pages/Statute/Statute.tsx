...
const Statute = () => {
  return (
    <section className={classes.statute}>
      ...
      <h2>
        <span>§</span> 1 DEFINICJE
      </h2>
      <div className={classes.statute__box}>
        <div>
        ...
        <div>
          ...
          buhcraft znajduje się pod adresem
          https://windmill-app-engarr.vercel.app/#strona-glowna
        </div>
        <div>
      ...
      <h2>
        <span>§</span> 2 KONTAKT ZE SPRZEDAWCĄ
      </h2>
      <div className={classes.statute__box}>
        <div>1. Polski Młyn Ul. Młyńska 29, 37-716 Orły</div>
        <div>2. Adres e-mail: kontakt-mlyn@gmail.com</div>
        <div>3. Tel. 796-284-109l</div>
      </div>
      <h2>
        <span>§</span> 3 WYMOGI TECHNICZNE
      </h2>
      <div className={classes.statute__box}>
        <div>
      ...
      <h2>
        <span>§</span> 6 REALIZACJA ZAMÓWIENIA
      </h2>
      <div className={classes.statute__box}>
      ...
      <h2>
        <span>§</span> 7 PRAWO ODSTĄPIENIA OD UMOWY
      </h2>
      <div className={classes.statute__box}>
        <div>
      ...
      <h2>
        <span>§</span> 8 WYJĄTKI OD PRAWA ODSTĄPIENIA OD UMOWY
      </h2>
      <div className={classes.statute__box}>
        <div>
